    ...
    >
      ...
      >
        <div className="relative z-10 grid grid-cols-[minmax(0,1fr)_auto] items-start gap-x-4 gap-y-3 py-6 md:grid-cols-[minmax(0,0.9fr)_minmax(0,1.4fr)_auto] md:items-center md:gap-x-8 md:py-8 lg:gap-x-12">
          <h3 className="min-w-0 break-words text-2xl font-semibold uppercase leading-[0.95] tracking-tight text-foreground transition-transform duration-200 group-hover:translate-x-1 group-focus-visible:translate-x-1 motion-reduce:transition-none sm:text-3xl lg:text-4xl">
            {project.title}
          </h3>
